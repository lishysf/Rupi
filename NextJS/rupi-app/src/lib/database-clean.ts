...
export async function initializeDatabase() {
  try {
    ...
    // Create unified transactions table (main table)
    await pool.query(`
    ...
    // Note: wallet_transfers table removed - all transfers handled by transactions table
...
// Note: WalletTransfer interface removed - all transfers now handled by Transaction interface
...
// Note: WalletTransferDatabase class removed - all transfers now handled by TransactionDatabase
