...
export default function FloatingChat() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      text: 'Hello! I\'m your AI financial assistant. I can help you with:\n\n**📝 Recording Transactions**\n• Simple: "Saving: Nabung/Save uang ke BCA 100K" or "Income: Gajian 8 juta ke BCA"\n• With Wallet: "Makan di warteg 15k pake BCA" or "Bayar bensin 100k dari Dana"\n• Multiple: "Hari ini beli kopi 50k pake Gojek, makan siang 25k tunai, terus dapat gaji 5 juta"\n\n**💳 Specify Your Wallet** (Recommended!)\nInclude wallet/payment method in your message:\n• E-wallets: "pake Gopay", "dari Dana", "via OVO", "pakai ShopeePay", "via LinkAja"\n• Banks: "pake BCA", "dari Mandiri", "via BRI", "pakai BNI", "pakai Jago"\n• Cash: "tunai", "cash", "uang cash"\n\nExample: "Belanja Indomaret 75k pake Dana" or "Isi bensin 150k tunai"\n\n**📊 Data Analysis**\n• Time-based: "Analisis pengeluaran hari ini" or "Breakdown minggu ini"\n• Category: "Pengeluaran makanan saya bulan ini" or "Breakdown transportasi"\n• General: "Berapa total pengeluaran?" or "Ringkasan keuangan"\n\n**⏰ Time Periods**\n• Today: "hari ini", "today"\n• Weekly: "minggu ini", "this week"\n• Monthly: "bulan ini", "this month"\n• All-time: (no time specified)\n\n**💡 Smart Features**\n• Understands Indonesian & English\n• Auto-categorizes your spending\n• Remembers conversation context for follow-up questions\n• Detects multiple transactions in one message\n\nTry: "Beli kopi 30k pake Gojek"',
      timestamp: new Date(),
      isUser: false
    }
  ]);
