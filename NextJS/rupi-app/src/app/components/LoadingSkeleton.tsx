...
export default function LoadingSkeleton({ 
  ...
  if (type === 'balance-overview') {
    return (
      <div className={`animate-pulse ${className}`}>
        <div className="relative h-full overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-800 shadow-xl border border-neutral-300/20 dark:border-neutral-600/20">
          <div className="p-6 h-full flex flex-col">
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <div className="w-3 h-3 bg-neutral-400/50 rounded-full mr-3"></div>
                <div className="w-24 h-5 bg-neutral-400/50 rounded"></div>
              </div>
              <div className="w-20 h-6 bg-neutral-400/50 rounded-full"></div>
            </div>
            
            {/* Main Balance */}
            <div className="flex-1 flex flex-col justify-center">
              <div className="text-center mb-4">
                <div className="w-32 h-8 bg-neutral-400/50 rounded mx-auto mb-2"></div>
                <div className="w-24 h-6 bg-neutral-400/50 rounded mx-auto"></div>
              </div>
              
              {/* Progress Bar */}
              <div className="w-full bg-neutral-400/30 rounded-full h-2 mb-2">
                <div className="bg-neutral-400/60 h-2 rounded-full w-3/4"></div>
              </div>
              <div className="text-center">
                <div className="w-20 h-4 bg-neutral-400/50 rounded mx-auto"></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="text-center">
                <div className="w-16 h-5 bg-neutral-400/50 rounded mx-auto mb-1"></div>
                <div className="w-12 h-4 bg-neutral-400/50 rounded mx-auto"></div>
              </div>
              <div className="text-center">
                <div className="w-16 h-5 bg-neutral-400/50 rounded mx-auto mb-1"></div>
                <div className="w-12 h-4 bg-neutral-400/50 rounded mx-auto"></div>
  ...
  if (type === 'financial-summary') {
    return (
      <div className={`animate-pulse ${className}`}>
        <div className="h-full bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-4">
  ...
  if (type === 'income-expense') {
    return (
      <div className={`animate-pulse ${className}`}>
        <div className="h-full bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="w-16 h-5 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
            <div className="w-6 h-6 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
          </div>
  ...
  if (type === 'trends-chart' || type === 'category-breakdown') {
    return (
      <div className={`animate-pulse ${className}`}>
        <div className="h-full bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            {Array.from({ length: 4 }, (_, i) => (
              <div key={i} className="space-y-2">
                ...
                <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2">
                  <div className="bg-neutral-300 dark:bg-neutral-600 h-2 rounded-full w-3/4"></div>
                </div>
              </div>
            ))}
          </div>
    ...
    return (
      <div className={`animate-pulse ${className}`}>
        <div className="h-full bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-4">
          ...
          <div className="text-center mb-4">
            <div className="w-20 h-20 bg-neutral-200 dark:bg-neutral-700 rounded-full mx-auto mb-2"></div>
            <div className="w-16 h-6 bg-neutral-200 dark:bg-neutral-700 rounded mx-auto"></div>
          </div>
          <div className="space-y-3">
            <div className="w-full h-4 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
            <div className="w-3/4 h-4 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
            <div className="w-1/2 h-4 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
          </div>
        </div>
      </div>
    );
      ...
      {!showChart && !showTable && (
        <div className="space-y-3">
          {Array.from({ length: lines }, (_, i) => (
            <div key={i} className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded" style={{
